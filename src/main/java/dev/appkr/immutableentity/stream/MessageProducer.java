...
import dev.appkr.immutableentity.config.Constants.MessageKey;
import dev.appkr.immutableentity.config.Constants.MessagePolicy;
...
import static dev.appkr.immutableentity.config.Constants.PROJECT_NAME;
