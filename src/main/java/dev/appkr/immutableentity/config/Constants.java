...
public class Constants {
  ...
  public static final String PROJECT_NAME = "immutableentity";
  ...
  public static class LogKey {
    public static final String HTTP_INBOUND_LOGGER = "dev.appkr.immutableentity.http.api";
    public static final String HTTP_OUTBOUND_LOGGER = "dev.appkr.immutableentity.http.external";
