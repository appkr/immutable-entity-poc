package dev.appkr.immutableentity.config.scheduler;
...
class AsyncTaskDecorator implements TaskDecorator {
  ...
  public Runnable decorate(Runnable runnable) {
     ...
     *   at dev.appkr.immutableentity.config.scheduler.AsyncTaskDecorator.lambda$decorate$0(AsyncTaskDecorator.java:21)"
